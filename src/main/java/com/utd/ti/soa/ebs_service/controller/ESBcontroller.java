...
public class ESBcontroller {
    ...
    public ResponseEntity<?> createUser(@RequestBody User user,
        ...
        String response = webClient.post()
                .uri("http://users.railway.internal/api/users/create")
                .bodyValue(user)
                .retrieve()
    ...
    public ResponseEntity<String> updateUser(@PathVariable String id,
        ...
        String response = webClient.patch()
                .uri("http://users.railway.internal/api/users/" + id)
    ...
    public ResponseEntity<String> recolectUsers(@RequestHeader(HttpHeaders.AUTHORIZATION) String token) {
        ...
        String response = webClient.get()
                .uri("http://users.railway.internal/api/users/all")
    ...
    public ResponseEntity<?> loginUser(@RequestBody Login loginRequest, String token) {
        ...
        String response = webClient.post()
                .uri("http://users.railway.internal/api/users/login")  // Aquí es donde debe apuntar
